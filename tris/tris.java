...
public class tris_iper_evoluto {
            ...
            if(rifarePartitaInt != 1){
                ...
                switch (scelta123) {
                    case "1" -> {
                        ...
                        System.out.println("(non ho ancora implementato questa funzione quindi ti farò ritornare alla domanda di sopra)");
                        rifarePartitaInt = 2;
                    }
                    case "2" -> {
                        giocareLocale = true;
                        ...
                        puntiGiocatore1 = 0;//se non lo faccio se si fa un altro game con nomi diversi hanno i punti di quelli precedenti
                        puntiGiocatore2 = 0;
                    ...
                    default -> {
                        System.out.println("Devi scrivere un numero di quelli sopra elencati");
                        rifarePartitaInt = 2;
                    }
                }
            }
